      ...
      <div className="flex">
        <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-slate-900 text-white z-10">
          ...
          <nav className="flex-1 px-4 py-6 space-y-2 z-10">
            ...
            <Link to={'/shop/products'} className={`flex items-center px-4 py-3 rounded-lg transition ${activePage === 'Products' ? 'bg-emerald-500 text-white' : 'text-slate-300 hover:bg-slate-800'}`}>
