...
import { getUsersOrder } from "../features/auth/AuthSlice"
...
export default function UserProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
    {
      orderModal && <OrderDetailsModal orderDetail={order} />
    }
      {/* Main Content */}
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {order.map((order) => (
                    <tr onClick={handleOrderModal} key={order.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 ">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full border border-gray-200 p-8 overflow-auto h-[65vh]">
